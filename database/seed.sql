...
('Administrator PGRI', 'admin@pgrikotamobagu.my.id', '$2y$12$tgXwVrFfGOwvzvq4uMBgS.pP8VTqdrFbGCsMbDKwMfC83qMYEnqsC', 'superadmin');
...
('email', 'sekretariat@pgrikotamobagu.my.id'),
('phone', '0434-000000'),
