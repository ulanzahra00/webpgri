    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-3">
                ...
                <a class="d-block text-light-emphasis" href="<?= e(url('public/?page=profil')) ?>">Profil</a>
                <a class="d-block text-light-emphasis" href="<?= e(url('public/?page=berita')) ?>">Berita</a>
                <a class="d-block text-light-emphasis" href="<?= e(url('public/?page=sekolah')) ?>">Data Sekolah</a>
                <a class="d-block text-light-emphasis" href="<?= e(url('public/?page=anggota')) ?>">Registrasi Anggota</a>
                <a class="d-block text-light-emphasis" href="<?= e(url('public/?page=keuangan')) ?>">Laporan Keuangan</a>
            </div>
            <div class="col-lg-4">
