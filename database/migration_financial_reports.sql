...
INSERT INTO financial_reports (title, period_month, period_year, deposit_date, category, income, expense, description, status)
SELECT 'Kegiatan Pelatihan Guru Kreatif', 1, 2026, '2026-01-18', 'Program Kerja', 0, 7350000, 'Pengeluaran konsumsi, narasumber, dan perlengkapan pelatihan guru.', 'published'
WHERE (SELECT COUNT(*) FROM financial_reports) = 1;

INSERT INTO financial_reports (title, period_month, period_year, deposit_date, category, income, expense, description, status)
SELECT 'Dukungan Mitra Pendidikan', 2, 2026, '2026-02-12', 'Bantuan / Sponsor', 5000000, 0, 'Penerimaan dukungan kegiatan dari mitra pendidikan daerah.', 'published'
